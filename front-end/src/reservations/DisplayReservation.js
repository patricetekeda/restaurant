...
const DisplayReservation = ({ reservation, loadDashboard }) => {
  ...
  return (
    <>
      <div
        className={`card card-bg text-white row flex-column flex-md-row rounded-lg mx-1 my-3 px-2 py-2`}
      >
        {/* Name & Phone */}
        ...
        {/* Reservation Status */}
        <div className={`col align-self-center`}>
          <h5 className="my-2 mb-3" data-reservation-id-status={reservation_id}>
            Status: {status}
          </h5>
        </div>
        {/* Buttons */}
